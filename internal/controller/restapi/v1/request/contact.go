...
type CreateContact struct {
	...
	Relationship *entity.ContactRelationship `json:"relationship"  validate:"required,oneof=Friend Family Colleague Other"  example:"Friend"`
...
type UpdateContact struct {
	...
	Relationship *entity.ContactRelationship `json:"relationship"  validate:"required,oneof=Friend Family Colleague Other"  example:"Family"`
